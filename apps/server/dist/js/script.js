...
loginBtn.addEventListener('click', async () => {
	...
	const frameworkRadio = document.querySelector("input[name='framework']:checked");
	if (!frameworkRadio) {
	...
	// check user exist
	try {
		const response = await fetch(`/api/users/exist/?username=${username}&framework=${framework}`, {
			method: 'get'
		});
